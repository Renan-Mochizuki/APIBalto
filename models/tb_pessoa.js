...
module.exports = function (sequelize, DataTypes) {
  var TB_PESSOA = sequelize.define("TB_PESSOA", {
    ...
    TB_PESSOA_NOME: DataTypes.STRING,
    TB_PESSOA_NOME_PERFIL: DataTypes.STRING,
    TB_PESSOA_EMAIL: DataTypes.STRING,
    TB_PESSOA_SENHA: DataTypes.STRING,
    TB_PESSOA_CEP: DataTypes.CHAR(8),
    TB_PESSOA_UF: DataTypes.CHAR(2),
    TB_PESSOA_CIDADE: DataTypes.STRING,
    TB_PESSOA_BAIRRO: DataTypes.STRING,
    TB_PESSOA_RUA: DataTypes.STRING,
    TB_PESSOA_NUMERO: DataTypes.INTEGER,
    TB_PESSOA_COMPLEMENTO: DataTypes.STRING,
    TB_PESSOA_DT_NASC: DataTypes.DATEONLY,
    TB_PESSOA_CPF: DataTypes.CHAR(11),
    TB_PESSOA_WHATSAPP: DataTypes.INTEGER,
    TB_PESSOA_INSTAGRAM: DataTypes.STRING,
    TB_PESSOA_FACEBOOK: DataTypes.STRING,
    TB_PESSOA_TELEFONE1: DataTypes.INTEGER,
    TB_PESSOA_TELEFONE2: DataTypes.INTEGER,
    ...
    TB_PESSOA_ANIMAL_AUSENCIA: DataTypes.STRING,
    ...
    TB_PESSOA_PIX: DataTypes.STRING,
    TB_PESSOA_LINK: DataTypes.STRING,
    TB_PESSOA_IMG: DataTypes.TEXT, /* BLOB */
  ...
  TB_PESSOA.associate = function (models) {
    ...
    TB_PESSOA.hasMany(models.TB_DENUNCIA, { foreignKey: "TB_PESSOA_ID" });
    TB_PESSOA.hasMany(models.TB_MENSAGEM, {
