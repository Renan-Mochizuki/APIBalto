...
selecaoFiltrar.get('/seltemperamentos/:TB_ANIMAL_ID', async (req, res) => {
    try {
...
selecaoFiltrar.get('/selsituacoes/:TB_ANIMAL_ID', async (req, res) => {
    try {
        const TB_ANIMAL_ID = req.params.TB_ANIMAL_ID;
...
selecaoFiltrar.get('/seltraumas/:TB_ANIMAL_ID', async (req, res) => {
    try {
        const TB_ANIMAL_ID = req.params.TB_ANIMAL_ID;
